...
export const Header = ({ data }: HeaderProps) => {
  return (
    <header className="bg-bg-card px-4 md:px-6 py-4 flex flex-wrap lg:flex-nowrap items-center justify-between border-b border-border-light sticky top-0 z-40 gap-4 lg:gap-0">
