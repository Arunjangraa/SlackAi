...
export const ConversionTab = () => {
  const config = useSelector((state: RootState) => state.dashboard.config?.ConversionTab || []);


  return (
    <div className="flex flex-col gap-6">
      <div className="flex justify-between items-center">
        <h2 className="text-xl font-bold text-text-heading tracking-tight">Conversion Funnel</h2>
      </div>
